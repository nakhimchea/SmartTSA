...
class SmartTSA(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            ...
            & (dataframe['peak_bottom'] != 'B6')
            & (dataframe['peak_bottom'] != 'B7')
            & (dataframe["volume"] > 0),
            "enter_long"] = 1
        ...
        dataframe.loc[
            ...
            & (dataframe['peak_bottom'] != 'P6')
            & (dataframe['peak_bottom'] != 'P7')
            & (dataframe["volume"] > 0)
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: datetime, current_rate: float,
        ...
        if current_profit < -0.086 * 3 and (current_time - trade.open_date_utc).days >= 1:
            return 'Kill Loss'
